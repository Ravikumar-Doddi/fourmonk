        ...
        <Row>
          <Col md={6} className="top-cont mt-5">
            <div className="">
              ...
              <Row>
                <Col xs={5} sm={5} md={6} className="mt-5 mt-md-0 mt-lg-0">
                  <div>
                ...
                <Col xs={7} sm={7} md={6} className="mt-5 mt-md-0 mt-lg-0">
                  <div>
          ...
          <Col className=" p-md-5 p-sm-0  modelView" md={6}>
            <div
              className="d-flex justify-content-between mt-5 mt-md-0"
              style={{ whiteSpace: "pre" }}
            >
              <span className="model d-none d-md-inline">01 SELECT MODEL </span>
            ...
            <Col xs={12} sm={6} md={6} lg={4}>
              <div className="d-none d-lg-block">
                <div className="adress">
                  Kasra No 351, 80 Feet Road <br /> Vinayak City <br /> Guru Marg,
                  Sirsi Road
                  <br />
                  Neemera, Bindayaka
                  <br />
          ...
          <div className="d-flex justify-content-between align-items-center flex-column flex-sm-row mb-3">
            ...
            <Col>
              <p className="privacy-policy" style={{ whiteSpace: "pre" }}>PRIVACY POLICY     TERMS & CONDITION</p>
            </Col>
